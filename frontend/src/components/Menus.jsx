      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            fresh ingredients, and modern culinary artistry to create an unforgettable dining experience.
        ...
        <div className="relative mb-20 rounded-[40px] overflow-hidden shadow-2xl">
          ...
          <div className="absolute inset-0 flex items-center">
            ...
            <div className="max-w-2xl px-8 md:px-16 text-white">
              ...
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full font-semibold shadow-xl transition duration-300 hover:scale-105">
